...
<div class="container mt-5 text-center">
  <h2><?= htmlspecialchars($user['user_name']) ?>'s Profile</h2>
  <img src="<?= $user['profile_picture'] ?: 'images/default.png' ?>" class="rounded-circle my-3" style="width: 150px; height: 150px; object-fit: cover;">
